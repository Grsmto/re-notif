...
var Notifs = (function (_Component) {
  ...
  function Notifs(props) {
    ...
    _get(Object.getPrototypeOf(Notifs.prototype), 'constructor', this).call(this, props);
  ...
  _createClass(Notifs, [{
    ...
    value: function onDismiss(id) {
      this.props.dispatch((0, _actionsNotifs.notifDismiss)(id));
    }
  }, {
    key: 'render',
    value: function render() {
      ...
      var dismissAfter = _props.dismissAfter;
      ...
      return _react2['default'].createElement(
        ...
        _react2['default'].createElement(
          ...
          { transitionName: 'notif', transitionAppear: true, transitionEnterTimeout: 300, transitionLeaveTimeout: 300 },
          items
        )
      );
    }
